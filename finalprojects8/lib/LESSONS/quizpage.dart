...
class _QuizPageState extends State<Quiz1> {
  ...
  int? selectedOptionIndex; // Track selected option for coloring
  ...
  void answerQuestion(int selectedOptionIndex) {
    setState(() {
      this.selectedOptionIndex = selectedOptionIndex; // Store selected option
                        ...
                        child: ElevatedButton(
                          style: ElevatedButton.styleFrom(
                            backgroundColor: selectedOptionIndex == null
                                ? Colors.deepPurple // Default color
                                : (entry.key ==
